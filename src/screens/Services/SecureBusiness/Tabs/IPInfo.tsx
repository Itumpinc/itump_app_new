...
import {ipInfoProtection} from '@src/utils/services';

export function IPInfo(props: any) {
      ...
      {status === 'active' && (
        <View>
          <Text style={styles.subText}>
            Some intellectual property information to help process
          </Text>
          <Gap height={hp(2)} />
          <View
            style={{
          ...
          <Gap height={hp(2)} />
          <Text style={styles.mainText}>Intellectual Property Details</Text>
          <Gap height={hp(2)} />
          <RenderDropdown
            name="protection_type"
            value={schema.data.protection_type}
            placeHolder="Select Type of Protection Needed"
            options={ipInfoProtection}
          />
          <RenderInput
            name="ip_description"
            value={schema.data.ip_description}
